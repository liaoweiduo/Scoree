...
public class ShowFace extends AppCompatActivity {
    ...
    //切换谱
    public void chageFrame_staff(int lineNumToChange){
    ...
    public void initialFrame_staff(int numOfLineShown){
        initialFrame_staff();
        initialStaff();
        int i=0;
    ...
    public void initialFrame_staff(){
